...
RUN apt-get update && \
    ...
    python3 python3-watchdog python3-pip python3-setuptools postgresql-13-pgtap libpq-dev && \
    ...
    apt-get -y remove build-essential python3-dev python3-wheel libpq-dev && \
