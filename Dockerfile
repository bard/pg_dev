...
RUN apt-get update && \
    apt-get install --no-install-recommends -y build-essential wget git ruby ruby-dev ruby-google-protobuf python3 python3-watchdog python3-pip python3-setuptools && \
